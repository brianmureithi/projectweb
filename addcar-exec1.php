...
if(isset($_POST['add_car'])){
	...
	$type = filter_var($_POST['car_name'],FILTER_SANITIZE_STRING, FILTER_FLAG_STRIP_HIGH);
 ...
 $owner_id = $_SESSION['id'];
		...
		$sql = mysqli_query($dbhandle,"SELECT * FROM cartypes WHERE car_type='".$type."'  LIMIT 1");
