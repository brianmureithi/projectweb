...
<body style="background:#FFFFAA">
		...
		<div class="header">
			<div class="header-top">
				<div class="container">
					...
					<div class="indicate">
						<p><i class="glyphicon glyphicon-" aria-hidden="true"></i>Welcome </p>
					</div>
				...
				<!---Brand and toggle get grouped for better mobile display--->
						<div class="navbar-header">
							...
							<div class="navbar-brand">
								<h1><a href="index.php">View Your Cars<span></span></a></h1>
							</div>
						</div>
    ...
    <div class="col-md-12 ser-grid">
              ...
              <br> 
							...
							<h4 style="font-family:Roboto;font-size:25px;#000000;">Below  are the Images and Details of this Car</h4>
							<h5 style="font-family:Roboto;font-size:15px;#000000;">Click on an image to Delete or Update the Description</h5>
              <p></p>
			  <br><br>
			   <ul >
              <?php Carsproject::gotoupload($_SESSION['car_id']); ?>
              </ul>
			  <br>
			  <br><br>
			   <form role="form" method="POST" action="delete-car.php">
			<fieldset>
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-md-6">
						 <div class="form-group">
                  <input class="btn btn-danger" type="submit" name="delete_car" 
                  value="Delete Car">
            </div>
					</div>
				</div>
           ...
           <?php Carsproject::getDetails($_SESSION['car_id']);  ?>
		   <br><br>
		   <?php Carsproject::getImages($_SESSION['car_id']);  ?>
          <br>  
