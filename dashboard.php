				...
				<!---Brand and toggle get grouped for better mobile display--->
						<div class="navbar-header">
							...
							<div class="navbar-brand">
								<h1><a href="index.php">DashBoard  <span></span></a></h1>
							</div>
						</div>
				...
				<div class="profile">
							...
							<?php 
									if (empty($_SESSION['profile']) === false)
									{
											  ...
											  <div class="thumbnail">
											  <img src="',$_SESSION['profile'],'" alt=" ', $_SESSION['firstname'],'\'s Profile Image">
											  </div>
											  </div>';
									}
											else{ 
			               ...
			               ?>
							...
							<h4><u>Welcome <?php echo$_SESSION['firstname'];?></u></h4>
							
						 
						
							<p style="color:#000000;font-size:22px;font-family:Sans Serrif;margin-top:20px;"> Welcome to the site. This is where you upload your Cars</p><br><br>
         
      <h4 style="align:center;">All your Cars</h4>
	  
			  <ol style="padding:15px;"> 
				 <?php Carsproject::getCars($_SESSION['id']); ?>
				</ol> 
		
		  <br><br><br>
								<div class="col-md-6">
							  <center><div style="border:thin solid #ffffff; border-radius:4px;background:#008000; max-width:250px;margin-left:20px;">
						<a href="add-car.php" style="color:#ffffff; padding:4px; font-size:20px;" >Click here to add Car</a></center>
</div>						
							 </div>
			</div> 
            </div>
