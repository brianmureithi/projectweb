						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<nav class="link-effect-2" id="link-effect-2">
								<ul class="nav navbar-nav">
									...
									<li  class="active"><a href="resetpassword.php.php"><span data-hover="Reset password">Reset Password</span></a></li>
			...
			<div class="col-md-8 col-md-offset-2">
					<div class="panel panel-default" style="margin-top:20px;">
									<div class=panel-heading"> 
										<h3 class="panel-title" style="pading:5px;; font-family:Roboto;font-size:28px;"><center>Reset Password</center></h3>
												<hr/>
									</div>
						<div class="panel-body"> 
								<form accept-charset="UTF-8" role="form" action="resetpassword-exec.php" method="POST">
										<fieldset>
												...
												<input class="btn btn-lg btn-success btn-block" type="submit" value="Reset" name="reset"> <br>
